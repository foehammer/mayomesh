...
We primarily work with two mesh networking platforms. Each has its strengths — see the dedicated pages for details on getting started with each one.

- **[Meshtastic](meshtastic)** — open-source, beginner-friendly, great for casual messaging, hiking, and community mesh networks.
- **[MeshCore](meshcore)** — infrastructure-focused, client/repeater architecture, suited to fixed network deployments.
